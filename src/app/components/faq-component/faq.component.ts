    ...
    this.faq = this.formatFAQ([
      {
        ...
        link: 'https://www.alz.org/alzheimer-demencia/que-es-la-demencia'
      },
      {
      ...
      },
      {
        ...
        link: `https://www.who.int/es/news-room/fact-sheets/detail/dementia`
      },
      {
        question: `¿Cuál causa de demencia es la más común?`,
        answer: `La enfermedad Alzheimer es la causa más común de los casos de demencia, acapara del 60% al 70% de todos los casos de demencia en el mundo.`,
        link: `https://www.who.int/es/news-room/fact-sheets/detail/dementia`
      },
      {
      ...
      },
      {
        ...
        link: `https://www.asha.org/public/speech/disorders/La-Afasia/`
      },
      {
        ...
        link: `https://psicologiaymente.com/clinica/apraxia`
      },
      {
        question: `¿En qué consiste la agnosia?`,
        answer: `La agnosia es la dificultad o incapacidad de procesar ciertos estímulos sensoriales. Generalmente las agnosias aparecen luego de lesiones cerebrales.`,
        link: `https://psicologiaymente.com/clinica/tipos-de-agnosia`
      }
    ])
  }
